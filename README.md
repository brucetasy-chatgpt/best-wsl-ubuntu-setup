...
```sh
sudo curl -fsSL 'https://gist.githubusercontent.com/doggy8088/de7f2cfcdecf34e09f2349a8c6867570/raw/4533f95aafeaf0b7b6e089c4aafcafa38be6616f/gemini-init.sh' -o /usr/local/bin/gemini-init
